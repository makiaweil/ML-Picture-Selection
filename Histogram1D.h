...
#ifndef __MyFirstApp__Histogram1D__
#define __MyFirstApp__Histogram1D__
...
public:
	...
	cv::Mat getHistogramImage(const cv::Mat &image){
        ...
        return getHistogramImageFromHistogram(hist);
	}
    
    cv::Mat getHistogramImageFromHistogram(const cv::MatND &hist){
...
#endif /* defined(__MyFirstApp__Histogram1D__) */
